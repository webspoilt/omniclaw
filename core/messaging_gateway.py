...
class WhatsAppBot:
    ...
    def __init__(self, session_name: str = "omniclaw", allowed_numbers: list[str] | None = None):
...
class MessagingGateway:
    ...
    def __init__(self):
        ...
        self.whatsapp: WhatsAppBot | None = None
        self.discord: DiscordBot | None = None
        self.slack: SlackBot | None = None
        self.imessage: IMessageBot | None = None
        self.matrix: MatrixBot | None = None
        self.command_handlers: dict[str, Callable[[Command], Any]] = {}
        self.orchestrator = None
        self.running = False

    def setup_telegram(self, token: str, allowed_users: list[str] | None = None):
        """Setup Telegram bot"""
        self.telegram = TelegramBot(token, allowed_users)
        self.telegram.add_message_handler(self._handle_incoming_message)
        logger.info("Telegram bot configured")

    def setup_whatsapp(self, allowed_numbers: list[str] | None = None):
        """Setup WhatsApp bot"""
    ...
    def _parse_command(self, message: Message) -> Command | None:
    ...
    async def broadcast(self, text: str, platforms: list[Platform] | None = None):
