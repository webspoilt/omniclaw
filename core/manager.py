...
from .orchestrator import SubTask, Task, WorkerRole
...
class ManagerAgent:
    ...
    async def decompose_goal(self, goal: str, context: dict | None = None) -> list[SubTask]:
        """
    ...
    def _build_decomposition_prompt(self, goal: str, context: dict | None) -> str:
...
- Appropriately sized (not too granular, not too large)"""
    ...
    def _adapt_decomposition(self, similar: dict, goal: str, context: dict | None) -> list[SubTask]:
